...
namespace SVGImporter
{
    ...
    public class SVGAtlas : MonoBehaviour {
            ...
            get {
                if(_ui == null)
                {
                    ...
                    if(atlasTextures != null && atlasTextures.Count > 0)
                        _ui.SetTexture ("_GradientColor", atlasTextures[0]);
                    _ui.SetTexture ("_GradientShape", gradientShapeTexture);
                    _ui.SetVector ("_Params", new Vector4 (atlasTextureWidth, atlasTextureHeight, gradientWidth, gradientHeight));
                }
                return _ui;
            }
        }
        ...
        public Material uiMask 
        {
            get {
                if(_uiMask == null)
                {
                    ...
                    if(atlasTextures != null && atlasTextures.Count > 0)
                        _uiMask.SetTexture ("_GradientColor", atlasTextures[0]);
                    _uiMask.SetTexture ("_GradientShape", gradientShapeTexture);
                    _uiMask.SetVector ("_Params", new Vector4 (atlasTextureWidth, atlasTextureHeight, gradientWidth, gradientHeight));
                }
                return _uiMask;
            }
        }
        ...
        public Material opaqueGradient
        {
            get {
                if(_opaqueGradient == null)
                {
                    ...
                    if(atlasTextures != null && atlasTextures.Count > 0)
                        _opaqueGradient.SetTexture ("_GradientColor", atlasTextures[0]);
                    _opaqueGradient.SetTexture ("_GradientShape", gradientShapeTexture);
                    _opaqueGradient.SetVector ("_Params", new Vector4 (atlasTextureWidth, atlasTextureHeight, gradientWidth, gradientHeight));
                }
        ...
        public Material transparentGradient
        {
            get {
                if(_transparentGradient == null)
                {
                    ...
                    if(atlasTextures != null && atlasTextures.Count > 0)
                        _transparentGradient.SetTexture ("_GradientColor", atlasTextures[0]);
                    _transparentGradient.SetTexture ("_GradientShape", gradientShapeTexture);
                    _transparentGradient.SetVector ("_Params", new Vector4 (atlasTextureWidth, atlasTextureHeight, gradientWidth, gradientHeight));
                }
        ...
        public static void ClearAll()
        {
            ...
            {
                DestroyObjectInternal(_Instance._ui);
                _Instance._ui = null;
            }
            if(_Instance._uiMask != null)
            {
                DestroyObjectInternal(_Instance._uiMask);
                _Instance._uiMask = null;
            }
            if(_Instance._opaqueSolid != null)
            {
                DestroyObjectInternal(_Instance._opaqueSolid);
                _Instance._opaqueSolid = null;
            }
            if(_Instance._transparentSolid != null)
            {
                DestroyObjectInternal(_Instance._transparentSolid);
                _Instance._transparentSolid = null;
            }
            if(_Instance._opaqueGradient != null)
            {
                DestroyObjectInternal(_Instance._opaqueGradient);
                _Instance._opaqueGradient = null;
            }
            if(_Instance._transparentGradient != null)
            {
                DestroyObjectInternal(_Instance._transparentGradient);
                _Instance._transparentGradient = null;
            }
...
//			texture.alphaIsTransparency = true;
        ...
        public CCGradient AddGradient(CCGradient gradient, bool renderAtlasTexture = true)
        {
            ...
            if(_atlasData == null) _atlasData = new SVGAtlasData();
