...
namespace SVGImporter 
{
    ...
    public struct SVGLayer
    {
        ...
        public SVGLayer(string name, Vector2[] vertices, int[] triangles, int depth, Rect bounds, SVGFill fill)
        {
            this.name = name;
        ...
        public static SVGAsset Load(string svgText, SVGImporterSettings settings = null)
        {
            ...
            */
            ...
            try {
                ...
                Mesh mesh = SVGMesh.CombineMeshes(SVGGraphics.layers, out outputShaders, asset._useGradients, asset._format, asset._compressDepth);
                if(mesh == null)
                    return null;
		...
		internal Material[] _editor_sharedMaterials
		{
			get {
				if(_sharedMaterials == null || _sharedMaterials.Length == 0)
				{
                    ...
                    if(hasGradients)
                    {
                        SVGAtlas.AssignMaterialGradients(_sharedMaterials, atlasTextures[0], SVGAtlas.gradientShapeTexture, 64, 4);
                    }
	            }
		...
		internal Material _editor_UIMaterial
		{
			get {
				if(_sharedUIMaterial == null)
				{
                    ...
                    SVGAtlas.AssignMaterialGradients(_sharedUIMaterial, atlasTextures[0], SVGAtlas.gradientShapeTexture, 64, 4);
				}
		...
		internal Material _editor_UIMaskMaterial
		{
			get {
				if(_sharedUIMaskMaterial == null)
				{
                    ...
                    SVGAtlas.AssignMaterialGradients(_sharedUIMaskMaterial, atlasTextures[0], SVGAtlas.gradientShapeTexture, 64, 4);
				}
